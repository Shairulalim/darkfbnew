...
# Embedded file name: Darkfb.py
# Compiled at: 2019-06-19 22:49:33
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCpSq_8-ATlziy6W7ed9GUjg?app=1')
                time.sleep(2)
                menu()
